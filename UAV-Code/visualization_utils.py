...
def visualize_boxes_and_labels_on_image_array(
      ...
      if scores is None:
        ...
        if not skip_labels:
          if not agnostic_mode:
            ...
            classOfVehicles.append(str(class_name))
        if not skip_scores:
          if not display_str:
  ...
  for box, color in box_to_color_map.items():
    ...
    coordinatesOfVehicles.append([ymin, xmin, ymax, xmax])
    if instance_masks is not None:
  ...
  return image, coordinatesOfVehicles, classOfVehicles
